...
import com.aiden.views.morphingbuttonlibrary.MorphingAnimation
import com.aiden.views.morphingbuttonlibrary.MorphingButton
import com.aiden.views.morphingbuttonlibrary.R
...
class IndeterminateProgressButton : MorphingButton {
    ...
    fun morphToProgress(
        backgroundColor: Int, progressCornerRadius: Int, width: Int, height: Int, duration: Int,
        progressColor1: Int
    ) {
        morphToProgress(
            backgroundColor, progressCornerRadius, width, height, duration, backgroundColor, progressColor1,
    ...
    fun morphToProgress(
        ...
        val longRoundedSquare = Params.create()
            .duration(duration)
    ...
    private fun setupProgressBarBounds() {
        val indicatorHeight = getHeight()
        val bottom = (getMeasuredHeight() - indicatorHeight) as Int
    ...
    class ProgressBar(private val mParent: View) {
        ...
        internal fun draw(canvas: Canvas) {
            val clipPath = Path()
            clipPath.addRoundRect(mBounds, mCornerRadius.toFloat(), mCornerRadius.toFloat(), Path.Direction.CW)
         ...
         */
        internal fun setBounds(left: Int, top: Int, right: Int, bottom: Int, cornerRadius: Int) {
